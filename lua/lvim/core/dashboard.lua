...
M.config = function(config)
    ...
    custom_section = {
      ...
      g = {
        description = { "  Choose Colorschema " },
...
M.setup = function()
    ...
    local lvim_site = [[|######## \\ 🪶:: Talking is cheap, show me you code !! // #########|]]
    ...
    if lvim_version then
        ...
        table.insert(footer, 2, " :: Version : [ "..lvim_version.." ]   ")
        table.insert(footer, 2, "")
        table.insert(footer, 6, "#####################################################################")
    end

    local text = require "lvim.interface.text"
    -- Use 0.49 as   counts for 2 characters
